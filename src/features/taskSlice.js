...
export const taskSlice = createSlice({
  ...
  initialState: {
    taskData: {
      tasks: {
        'task-1': {id: 'task-1', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-1', content: 'This is my first task. Be Gentle'},
        'task-2': {id: 'task-2', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-1', content: 'This is my second task. Never mind'},
        'task-3': {id: 'task-3', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-1', content: 'This is my third task. I am improving'},
        'task-4': {id: 'task-4', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-2', content: 'This is my forth task. I feel confident now'},
        'task-5': {id: 'task-5', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-2', content: 'This is my fifth task. I can control this anyhow'},
        'task-6': {id: 'task-6', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-2', content: 'This is my sixth task, i guess. But does\'t matter now'},
        'task-7': {id: 'task-7', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-3', content: 'This is my forth tasks. I feel confident now'},
        'task-8': {id: 'task-8', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-3', content: 'This is my fifth tasks. I can control this anyhow'},
        'task-9': {id: 'task-9', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-3', content: 'This is my sixth tasks, i guess. But does\'t matter now'},
        'task-10': {id: 'task-10', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-4', content: 'This is my first tasks. Be Gentle'},
        'task-11': {id: 'task-11', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-4', content: 'This is my second tasks. Never mind'},
        'task-12': {id: 'task-12', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-4', content: 'This is my third tasks. I am improving'},
        'task-13': {id: 'task-13', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-5', content: 'This is my first tasks. Be Gentle'},
        'task-14': {id: 'task-14', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-5', content: 'This is my second tasks. Never mind'},
        'task-15': {id: 'task-15', projectIds: [], labelIds: [], elClasses: [], status: {completed: false, prevColumnId: null}, columnId: 'column-5', content: 'This is my third tasks. I am improving'},
      },
      columns: {
        'column-1': {
          id: 'column-1',

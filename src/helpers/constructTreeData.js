...
const taskData = {
  tasks: {
    "task-1": {
      ...
      subTasks: ["task-4", "task-5", "task-6"],
    },
    "task-2": {
      id: "task-2",
      columnId: "column-1",
      content: "This is my second task. Never mind",
      subTasks: ["task-7", "task-8", "task-9"],
    },
    "task-3": {
      id: "task-3",
      columnId: "column-1",
      content: "This is my third task. I am improving",
      subTasks: ["task-10", "task-11", "task-12"],
    },
    "task-4": {
      id: "task-4",
      columnId: "column-2",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: "task-9",
        title:
          "[task-9] This is my sixth tasks, i guess. But does't matter now",
        children: [],
      },
    ],
  },
...
function populateChild(tasks, taskId) {
  ...
  const filledSubTasks = curTask.subTasks.map((taskId) =>
    populateChild(tasks, taskId)
  );

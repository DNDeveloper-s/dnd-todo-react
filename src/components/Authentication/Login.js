...
const Login = (props) => {
  ...
  const {handleValue, data} = useForm({email: {}, password: {}});
  ...
  function handleLogin() {
    post(constants.ENDPOINTS.LOGIN, formData(getData()))
      .then(res => {
        if(res.data.type === 'error') {
          ...
          get(constants.ENDPOINTS.GET_CURRENT_USER, {headers: {'Authorization': 'Bearer ' + res.data.token}})
            .then((getRes) => {
              console.log(getRes);
              dispatch(AUTH_STATE({
                isLoggedIn: true,
                token: res.data.token,
                user: getRes.data.user
              }))
            })
        }
      })
    ...
    <>
      <div className="auth_modal-side_bar">
        ...
        <div className="auth_modal-side_bar-content pv-100">
          ...
          <div className="row flexCentered mt-20 auth_modal-side_bar-content-desc">
            <p>No Credit Card Required. 30 Days Free Trial</p>
          </div>
          <div className="row flexCentered auth_modal-side_bar-content-action">
            <div className="generic_btn pink" onClick={goToSignUp}>
      ...
      <div className="auth_modal-main pv-50 ph-50">
        ...
        <div className="mh-60 relative">
          <div className="row flexCentered mt-80 heading_1">
            <p>Welcome Back!</p>
          </div>
          ...
          <div className="row mv-30">
            ...
            <div className="row_item nowrap black-30 account-separator">
              <p>Or Log in with your dnd-todo's account</p>
            </div>
